/**
 * Componente React para integrar catálogo de muebles en otra página web Astro
 * 
 * USO EN ASTRO:
 * ---
 ...
 * ---
 * 
 * <CotizadorMuebles client:load urlCotizador="https://..." estilo="banner" />
 */

import { useState } from 'react';

export interface CotizadorMueblesProps {
  /** URL del catálogo de muebles */
  urlCotizador?: string;
...
export default function CotizadorMuebles({
  urlCotizador = 'https://cotizador-app-two.vercel.app/muebles-publico',
  titulo = 'Diseña tu Mueble Ideal',
  descripcion = 'Explora nuestro catálogo y cotiza tu mueble personalizado con materiales y acabados de alta calidad',
  estilo = 'banner',
  className = '',
  altura = '800px'
}: CotizadorMueblesProps) {
  ...
  if (estilo === 'flotante') {
    return (
      ...
      >
        ...
        <span className="hidden sm:inline">Cotizar Mueble</span>
      </a>
    );
  }
 ...
 */
export function CotizadorMueblesIframe({
  urlCotizador = 'https://cotizador-app-two.vercel.app/muebles-publico',
  altura = '800px',
  className = ''
}: {
