/**
 * Página de reportes con gráficos y analíticas
 */
import { VentasPorCategoriaChart, DistribucionGananciasChart } from './ui/DashboardCharts';
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-3xl font-bold text-gray-900">Reportes & Analíticas Clave</h1>
          <p className="text-gray-600 mt-1">Análisis detallado de ventas y ganancias</p>
        </div>
        <div className="flex items-center gap-4">
          <select className="rounded-lg border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 px-4 py-2">
            <option>Mes: Noviembre 2024</option>
