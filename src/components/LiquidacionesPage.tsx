  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-gray-500 rounded-lg shadow-md border-l-4 border-blue-300 p-6">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-sm text-gray-100">Pendiente Vendedores</p>
              <p className="text-2xl font-bold text-blue-200">
                ${totalPendienteVendedores.toLocaleString('es-CO')}
              </p>
            </div>
            <div className="p-3 bg-blue-200/20 rounded-full">
        ...
        <div className="bg-gray-500 rounded-lg shadow-md border-l-4 border-amber-300 p-6">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-sm text-gray-100">Pendiente Trabajadores</p>
              <p className="text-2xl font-bold text-amber-200">
                ${totalPendienteTrabajadores.toLocaleString('es-CO')}
              </p>
            </div>
            <div className="p-3 bg-amber-200/20 rounded-full">
        ...
        <div className="bg-gray-500 rounded-lg shadow-md border-l-4 border-green-300 p-6">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-sm text-gray-100">Total Pendiente</p>
              <p className="text-2xl font-bold text-green-200">
                ${(totalPendienteVendedores + totalPendienteTrabajadores).toLocaleString('es-CO')}
              </p>
            </div>
            <div className="p-3 bg-green-200/20 rounded-full">
