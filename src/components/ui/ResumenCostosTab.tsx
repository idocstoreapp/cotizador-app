  ...
  return (
    <div className="space-y-4 sm:space-y-6 max-w-full overflow-x-hidden">
      ...
      <div className="bg-white border border-gray-200 rounded-lg overflow-hidden">
        <h3 className="text-base sm:text-lg font-semibold text-gray-900 p-3 sm:p-4 bg-gray-50 border-b border-gray-200">
          📋 Detalle de lo Cotizado
        </h3>
          ...
          {itemsCotizados.length > 0 ? (
            <div className="space-y-3">
              {itemsCotizados.map((item: any, index: number) => {
                ...
                return (
                  <div key={index} className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3 p-3 bg-gray-50 rounded-lg border border-gray-200">
                    <div className="flex-1 w-full sm:w-auto">
                      <p className="font-medium text-gray-900 text-sm sm:text-base">{item.nombre || `Item ${index + 1}`}</p>
                      {medidasTexto && (
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6">
        ...
        <div className="bg-green-50 p-4 sm:p-6 rounded-lg">
          ...
          {comparacion.ivaReal > 0 && (
            <p className="text-xs text-gray-500 mt-2">
              Incluye IVA: ${comparacion.ivaReal.toLocaleString('es-CO')}
            </p>
          )}
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6">
        ...
        {/* Utilidad Real */}
        <div className={`p-4 sm:p-6 rounded-lg ${comparacion.utilidadReal >= 0 ? 'bg-green-50' : 'bg-red-50'}`}>
          <h3 className="text-xs sm:text-sm font-medium text-gray-600 mb-2">Utilidad Real</h3>
          <p className={`text-2xl sm:text-3xl font-bold ${comparacion.utilidadReal >= 0 ? 'text-green-600' : 'text-red-600'}`}>
          ...
          <p className="text-xs text-gray-500 mt-2">
            Total cotizado - Total real gastado (incluye IVA)
          </p>
        </div>
      </div>
        ...
        <div className="divide-y divide-gray-200">
          ...
          <div className="p-3 sm:p-4">
            <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-3 mb-2">
              <h4 className="font-medium text-gray-900 text-sm sm:text-base">Materiales</h4>
              <div className="flex flex-wrap gap-2 sm:gap-4 w-full sm:w-auto">
                <div className="text-left sm:text-right flex-1 sm:flex-none min-w-[100px]">
                  <p className="text-xs sm:text-sm text-gray-600">Presupuestado</p>
                  <p className="font-medium text-sm sm:text-base">${comparacion.materiales.presupuestado.toLocaleString('es-CO')}</p>
                </div>
                <div className="text-left sm:text-right flex-1 sm:flex-none min-w-[100px]">
          ...
          <div className="p-3 sm:p-4">
            <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-3 mb-2">
              <h4 className="font-medium text-gray-900 text-sm sm:text-base">Mano de Obra</h4>
              <div className="flex flex-wrap gap-2 sm:gap-4 w-full sm:w-auto">
                <div className="text-left sm:text-right flex-1 sm:flex-none min-w-[100px]">
                  <p className="text-xs sm:text-sm text-gray-600">Presupuestado</p>
                  <p className="font-medium text-sm sm:text-base">${comparacion.servicios.presupuestado.toLocaleString('es-CO')}</p>
                </div>
                <div className="text-left sm:text-right flex-1 sm:flex-none min-w-[100px]">
                  <p className="text-xs sm:text-sm text-gray-600">Real</p>
          ...
          {comparacion.gastosHormiga.real > 0 && (
            <div className="p-3 sm:p-4 bg-yellow-50">
              <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-3 mb-2">
                <h4 className="font-medium text-gray-900 text-sm sm:text-base">Gastos Hormiga</h4>
                <div className="flex flex-wrap gap-2 sm:gap-4 w-full sm:w-auto">
                  <div className="text-left sm:text-right flex-1 sm:flex-none min-w-[100px]">
                    <p className="text-xs sm:text-sm text-gray-600">Presupuestado</p>
                    <p className="font-medium text-sm sm:text-base">${comparacion.gastosHormiga.presupuestado.toLocaleString('es-CO')}</p>
                  </div>
                  <div className="text-left sm:text-right flex-1 sm:flex-none min-w-[100px]">
                    <p className="text-xs sm:text-sm text-gray-600">Real</p>
                    <p className="font-medium text-sm sm:text-base">${comparacion.gastosHormiga.real.toLocaleString('es-CO')}</p>
                  </div>
                  <div className="text-left sm:text-right flex-1 sm:flex-none min-w-[100px] text-yellow-600">
                    <p className="text-xs sm:text-sm">Diferencia</p>
                    <p className="font-bold text-sm sm:text-base">
          ...
          {comparacion.transporte.real > 0 && (
            <div className="p-3 sm:p-4 bg-blue-50">
              <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-3 mb-2">
                <h4 className="font-medium text-gray-900 text-sm sm:text-base">Transporte</h4>
                <div className="flex flex-wrap gap-2 sm:gap-4 w-full sm:w-auto">
                  <div className="text-left sm:text-right flex-1 sm:flex-none min-w-[100px]">
                    <p className="text-xs sm:text-sm text-gray-600">Presupuestado</p>
                    <p className="font-medium text-sm sm:text-base">${comparacion.transporte.presupuestado.toLocaleString('es-CO')}</p>
                  </div>
                  <div className="text-left sm:text-right flex-1 sm:flex-none min-w-[100px]">
                    <p className="text-xs sm:text-sm text-gray-600">Real</p>
                    <p className="font-medium text-sm sm:text-base">${comparacion.transporte.real.toLocaleString('es-CO')}</p>
                  </div>
                  <div className="text-left sm:text-right flex-1 sm:flex-none min-w-[100px] text-blue-600">
                    <p className="text-xs sm:text-sm">Diferencia</p>
                    <p className="font-bold text-sm sm:text-base">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
        <div className="text-center p-4 bg-gray-50 rounded-lg">
          <p className="text-xs sm:text-sm text-gray-600 mb-1">Eficiencia de Presupuesto</p>
        ...
        <div className="text-center p-4 bg-gray-50 rounded-lg">
          <p className="text-xs sm:text-sm text-gray-600 mb-1">Margen de Utilidad</p>
        ...
        <div className="text-center p-4 bg-gray-50 rounded-lg">
          <p className="text-xs sm:text-sm text-gray-600 mb-1">Estado del Proyecto</p>
